...
if __name__ == "__main__":
    ...
    program_name = f"{os.path.basename(__file__)}"
    # register(exit_handler_driver, chrome_driver, program_name)

    coin1 = "0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee"
    coin2 = "0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48"
    # Get page to scrape
    url = f"https://matcha.xyz/markets/1/{coin1}/{coin2}"
